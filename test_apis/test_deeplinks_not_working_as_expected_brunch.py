...
class TestDeepLinksNotWorkingAsExpectedBrunchEndPoints(object):
    name = 'deep_links_not_working_as_expected_brunch'
    url = DEEPLINKS_NOT_WORKING_AS_EXPECTED_BRUNCH
    ua = UserAgent()
